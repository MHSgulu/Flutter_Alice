...
class ExampleFlipPanelPage extends StatelessWidget {
  @override
      ...
      body: Column(
        children: [
          ListTile(
            ...
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => AnimatedImagePage())),
          ),
          ListTile(
            title: Text('FlipClock'),
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => FlipClockPage())),
          ),
          ListTile(
            title: Text('CountdownClock'),
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => CountdownClockPage())),
          ),
          ListTile(
            title: Text('DaysToGo'),
            onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => ReverseCountdown())),
          ),
        ],
      ),
    );
