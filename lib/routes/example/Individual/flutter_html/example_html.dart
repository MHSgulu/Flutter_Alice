...
class HtmlExamplePage extends StatefulWidget {
  HtmlExamplePage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _HtmlExamplePageState createState() => new _HtmlExamplePageState();
}
...
class _HtmlExamplePageState extends State<HtmlExamplePage> {
  @override
