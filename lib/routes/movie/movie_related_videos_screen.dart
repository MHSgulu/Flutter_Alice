  ...
  void replaceTrailerVideo(String url, int currentIndex) {
    ...
    setState(() {
      ...
      _videoPlayerController =
          VideoPlayerController.network(url.replaceRange(0, 4, 'https'));
      _chewieController = ChewieController(
        videoPlayerController: _videoPlayerController,
        aspectRatio: 1.6,
        autoPlay: true,
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Container(
                      ...
                      child: FlatButton(
                        ...
                        onPressed: () {
                          replaceTrailerVideo(
                              moiveDetailsTrailerlList[index].resourceUrl,
                              index);
                        },
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child:
                                    Text(moiveDetailsTrailerlList[index].title),
                              ),
                            ),
                          ],
                        ),
                ...
                moiveDetailsBlooperlList.isNotEmpty
                    ? ListView.separated(
                        shrinkWrap: true,
                        physics: NeverScrollableScrollPhysics(),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Container(
                            padding: EdgeInsets.fromLTRB(16, 0, 16, 0),
                            child: FlatButton(
                              color: index == selectedBlooperIndex
                                  ? Colors.orange[100]
                                  : Colors.white12,
                              splashColor: Colors.orange[100],
                              onPressed: () {
                                replaceBlooperVideo(
                                    moiveDetailsBlooperlList[index].resourceUrl,
                                    index);
                              },
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                  ...
                                  Container(
                                    child: Card(
                                      ...
                                      child: Stack(
                                        ...
                                        children: <Widget>[
                                          Image.network(
                                            moiveDetailsBlooperlList[index]
                                                .medium,
                                            width: 120,
                                            //height: 150,
                                            fit: BoxFit.cover,
                ...
                moiveDetailsCliplList.isNotEmpty
                    ? ListView.separated(
                        shrinkWrap: true,
                        physics: NeverScrollableScrollPhysics(),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Container(
                            padding: EdgeInsets.fromLTRB(16, 0, 16, 0),
                            child: FlatButton(
                              color: index == selectedClipIndex
                                  ? Colors.orange[100]
                                  : Colors.white12,
                              splashColor: Colors.orange[100],
                              onPressed: () {
                                replaceClipVideo(
                                    moiveDetailsCliplList[index].resourceUrl,
                                    index);
                              },
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Container(
                                      padding: EdgeInsets.fromLTRB(16, 4, 0, 0),
                                      child: Text(
                                          moiveDetailsCliplList[index].title),
                                    ),
                                  ),
                                ],
                              ),
