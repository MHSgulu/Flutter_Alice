...
class GifPictureList extends StatefulWidget {
  @override
  _GifPictureListState createState() => _GifPictureListState();
}
...
class _GifPictureListState extends State<GifPictureList> with AutomaticKeepAliveClientMixin{
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return dataList.isEmpty ? MyLoadingIndicator() : gifPictureListView();
  }

  Widget gifPictureListView() {
