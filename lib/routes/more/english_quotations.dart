                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        child: ListTile(
                          //leading: Text('1'),
                          title: Text(
                              snapshot.data.showapiResBody.data[index].english),
                          subtitle: Text(
                              snapshot.data.showapiResBody.data[index].chinese),
                          ...
                          ///如果为true，则[ListTile]将具有垂直密集布局。默认false 密集列表平铺默认为较小的高度。
                          ///瓷砖的内部填充。
                          ...
                          onTap: () {
                            ...
                            ToolUtil.setTextToClipboard(snapshot
                                .data.showapiResBody.data[index].english);
                            ToolUtil.launchWebUrl(Util.googleTranslationUrl);
                          },
                          onLongPress: () {
                            Fluttertoast.showToast(msg: '已复制中文翻译到剪切板');
                            ToolUtil.setTextToClipboard(snapshot
                                .data.showapiResBody.data[index].chinese);
                            ToolUtil.launchWebUrl(Util.googleTranslationUrl);
                          },
