...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case WrittenJokesEntity:
			...
			return writtenJokesResultShowapiResBodyContentlistFromJson(data as WrittenJokesResultShowapiResBodyContentlist, json) as T;			case MobiePhoneEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case WrittenJokesEntity:
			...
			return writtenJokesResultShowapiResBodyContentlistToJson(data as WrittenJokesResultShowapiResBodyContentlist);			case MobiePhoneEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'WrittenJokesEntity':
			...
			return WrittenJokesResultShowapiResBodyContentlist().fromJson(json);			case 'MobiePhoneEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'WrittenJokesEntity':
			...
			return List<WrittenJokesResultShowapiResBodyContentlist>();			case 'MobiePhoneEntity':
