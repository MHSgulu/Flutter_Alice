...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case NewsEntity:
			...
			return newsResultResultListFromJson(data as NewsResultResultList, json) as T;			case MobiePhoneEntity:
			...
			return mobiePhoneResultResultFromJson(data as MobiePhoneResultResult, json) as T;			case WrittenJokesEntity:
			...
			return writtenJokesResultShowapiResBodyContentlistFromJson(data as WrittenJokesResultShowapiResBodyContentlist, json) as T;			case PictureJokeEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case NewsEntity:
			...
			return newsResultResultListToJson(data as NewsResultResultList);			case MobiePhoneEntity:
			...
			return mobiePhoneResultResultToJson(data as MobiePhoneResultResult);			case WrittenJokesEntity:
			...
			return writtenJokesResultShowapiResBodyContentlistToJson(data as WrittenJokesResultShowapiResBodyContentlist);			case PictureJokeEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'NewsEntity':
			...
			return NewsResultResultList().fromJson(json);			case 'MobiePhoneEntity':
			...
			return MobiePhoneResultResult().fromJson(json);			case 'WrittenJokesEntity':
			...
			return WrittenJokesResultShowapiResBodyContentlist().fromJson(json);			case 'PictureJokeEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'NewsEntity':
			...
			return List<NewsResultResultList>();			case 'MobiePhoneEntity':
			return List<MobiePhoneEntity>();			case 'MobiePhoneResult':
			return List<MobiePhoneResult>();			case 'MobiePhoneResultResult':
			return List<MobiePhoneResultResult>();			case 'WrittenJokesEntity':
			...
			return List<WrittenJokesResultShowapiResBodyContentlist>();			case 'PictureJokeEntity':
			...
			return List<GifPictureJokesResultShowapiResBodyContentlist>();    }
    return null;
  }
