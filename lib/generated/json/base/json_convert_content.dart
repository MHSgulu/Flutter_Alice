...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case MovieStillsEntity:
			...
			return movieStillsSubjectImagesFromJson(data as MovieStillsSubjectImages, json) as T;			case WrittenJokesEntity:
			...
			return searchNewsResultResultListFromJson(data as SearchNewsResultResultList, json) as T;			case FilmMakerAlbumEntity:
			...
			return filmMakerAlbumCelebrityAvatarsFromJson(data as FilmMakerAlbumCelebrityAvatars, json) as T;			case ShortFilmReviewEntity:
			...
			return shortFilmReviewSubjectImagesFromJson(data as ShortFilmReviewSubjectImages, json) as T;			case RealTimeHotspotEntity:
			...
			return realTimeHotspotResultShowapiResBodyListFromJson(data as RealTimeHotspotResultShowapiResBodyList, json) as T;			case MoiveDetailsEntity:
			...
			return gifPictureJokesResultShowapiResBodyContentlistFromJson(data as GifPictureJokesResultShowapiResBodyContentlist, json) as T;			case MovieEntity:
			...
			return quotationShowapiResBodyDataFromJson(data as QuotationShowapiResBodyData, json) as T;			case PictureJokeEntity:
			...
			return pictureJokeResultShowapiResBodyContentlistFromJson(data as PictureJokeResultShowapiResBodyContentlist, json) as T;			case FilmMakerWorkEntity:
			...
			return filmMakerWorkWorksSubjectImagesFromJson(data as FilmMakerWorkWorksSubjectImages, json) as T;			case MobiePhoneEntity:
			...
			return mobiePhoneResultResultFromJson(data as MobiePhoneResultResult, json) as T;			case FilmMakerWorksEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case MovieStillsEntity:
			...
			return movieStillsSubjectImagesToJson(data as MovieStillsSubjectImages);			case WrittenJokesEntity:
			...
			return searchNewsResultResultListToJson(data as SearchNewsResultResultList);			case FilmMakerAlbumEntity:
			...
			return filmMakerAlbumCelebrityAvatarsToJson(data as FilmMakerAlbumCelebrityAvatars);			case ShortFilmReviewEntity:
			...
			return shortFilmReviewSubjectImagesToJson(data as ShortFilmReviewSubjectImages);			case RealTimeHotspotEntity:
			...
			return realTimeHotspotResultShowapiResBodyListToJson(data as RealTimeHotspotResultShowapiResBodyList);			case MoiveDetailsEntity:
			...
			return gifPictureJokesResultShowapiResBodyContentlistToJson(data as GifPictureJokesResultShowapiResBodyContentlist);			case MovieEntity:
			...
			return quotationShowapiResBodyDataToJson(data as QuotationShowapiResBodyData);			case PictureJokeEntity:
			...
			return pictureJokeResultShowapiResBodyContentlistToJson(data as PictureJokeResultShowapiResBodyContentlist);			case FilmMakerWorkEntity:
			...
			return filmMakerWorkWorksSubjectImagesToJson(data as FilmMakerWorkWorksSubjectImages);			case MobiePhoneEntity:
			...
			return mobiePhoneResultResultToJson(data as MobiePhoneResultResult);			case FilmMakerWorksEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'MovieStillsEntity':
			...
			return MovieStillsSubjectImages().fromJson(json);			case 'WrittenJokesEntity':
			...
			return SearchNewsResultResultList().fromJson(json);			case 'FilmMakerAlbumEntity':
			...
			return FilmMakerAlbumCelebrityAvatars().fromJson(json);			case 'ShortFilmReviewEntity':
			...
			return ShortFilmReviewSubjectImages().fromJson(json);			case 'RealTimeHotspotEntity':
			...
			return RealTimeHotspotResultShowapiResBodyList().fromJson(json);			case 'MoiveDetailsEntity':
			...
			return GifPictureJokesResultShowapiResBodyContentlist().fromJson(json);			case 'MovieEntity':
			...
			return QuotationShowapiResBodyData().fromJson(json);			case 'PictureJokeEntity':
			...
			return PictureJokeResultShowapiResBodyContentlist().fromJson(json);			case 'FilmMakerWorkEntity':
			...
			return FilmMakerWorkWorksSubjectImages().fromJson(json);			case 'MobiePhoneEntity':
			...
			return MobiePhoneResultResult().fromJson(json);			case 'FilmMakerWorksEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'MovieStillsEntity':
			...
			return List<MovieStillsSubjectImages>();			case 'WrittenJokesEntity':
			...
			return List<SearchNewsResultResultList>();			case 'FilmMakerAlbumEntity':
			...
			return List<FilmMakerAlbumCelebrityAvatars>();			case 'ShortFilmReviewEntity':
			...
			return List<ShortFilmReviewSubjectImages>();			case 'RealTimeHotspotEntity':
			...
			return List<RealTimeHotspotResultShowapiResBodyList>();			case 'MoiveDetailsEntity':
			...
			return List<GifPictureJokesResultShowapiResBodyContentlist>();			case 'MovieEntity':
			...
			return List<QuotationShowapiResBodyData>();			case 'PictureJokeEntity':
			...
			return List<PictureJokeResultShowapiResBodyContentlist>();			case 'FilmMakerWorkEntity':
			...
			return List<FilmMakerWorkWorksSubjectImages>();			case 'MobiePhoneEntity':
			return List<MobiePhoneEntity>();			case 'MobiePhoneResult':
			return List<MobiePhoneResult>();			case 'MobiePhoneResultResult':
			return List<MobiePhoneResultResult>();			case 'FilmMakerWorksEntity':
			...
			return List<FilmMakerWorksWorksSubjectImages>();    }
    return null;
  }
