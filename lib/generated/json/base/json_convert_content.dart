...
class JsonConvert<T> {
  ...
  //Go back to a single instance by type
	static _fromJsonSingle<M>( json) {
		...
		if(type == (MobiePhoneEntity).toString()){
		...
		}	else if(type == (RecipeClassificationEntity).toString()){
  ...
  //list is returned by type
	static M _getListChildType<M>(List data) {
		...
		}	else if(List<RecipeClassificationEntity>() is M){
