...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case MovieStillsEntity:
			...
			return movieStillsSubjectImagesFromJson(data as MovieStillsSubjectImages, json) as T;			case MtimeHotMovieEntity:
			...
			return mtimeHotMoviePromoFromJson(data as MtimeHotMoviePromo, json) as T;			case FilmMakerWorkEntity:
			...
			return filmMakerWorkWorksSubjectImagesFromJson(data as FilmMakerWorkWorksSubjectImages, json) as T;			case MTimeMovieDetailEntity:
			...
			return mTimeMovieDetailDataRelatedFromJson(data as MTimeMovieDetailDataRelated, json) as T;			case HotWordTypeEntity:
			...
			return moiveDetailsPopularReviewsAuthorFromJson(data as MoiveDetailsPopularReviewsAuthor, json) as T;			case FilmMakerEntity:
			...
			return filmMakerPhotoFromJson(data as FilmMakerPhoto, json) as T;			case ShortFilmReviewEntity:
			...
			return shortFilmReviewSubjectImagesFromJson(data as ShortFilmReviewSubjectImages, json) as T;			case SearchNewsEntity:
			...
			return searchNewsResultResultListFromJson(data as SearchNewsResultResultList, json) as T;			case FilmMakerWorksEntity:
			...
			return newsResultResultListFromJson(data as NewsResultResultList, json) as T;			case WrittenJokesEntity:
			...
			return writtenJokesResultShowapiResBodyContentlistFromJson(data as WrittenJokesResultShowapiResBodyContentlist, json) as T;			case QuotationEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case MovieStillsEntity:
			...
			return movieStillsSubjectImagesToJson(data as MovieStillsSubjectImages);			case MtimeHotMovieEntity:
			...
			return mtimeHotMoviePromoToJson(data as MtimeHotMoviePromo);			case FilmMakerWorkEntity:
			...
			return filmMakerWorkWorksSubjectImagesToJson(data as FilmMakerWorkWorksSubjectImages);			case MTimeMovieDetailEntity:
			...
			return mTimeMovieDetailDataRelatedToJson(data as MTimeMovieDetailDataRelated);			case HotWordTypeEntity:
			...
			return moiveDetailsPopularReviewsAuthorToJson(data as MoiveDetailsPopularReviewsAuthor);			case FilmMakerEntity:
			...
			return filmMakerPhotoToJson(data as FilmMakerPhoto);			case ShortFilmReviewEntity:
			...
			return shortFilmReviewSubjectImagesToJson(data as ShortFilmReviewSubjectImages);			case SearchNewsEntity:
			...
			return searchNewsResultResultListToJson(data as SearchNewsResultResultList);			case FilmMakerWorksEntity:
			...
			return newsResultResultListToJson(data as NewsResultResultList);			case WrittenJokesEntity:
			...
			return writtenJokesResultShowapiResBodyContentlistToJson(data as WrittenJokesResultShowapiResBodyContentlist);			case QuotationEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'MovieStillsEntity':
			...
			return MovieStillsSubjectImages().fromJson(json);			case 'MtimeHotMovieEntity':
			...
			return MtimeHotMoviePromo().fromJson(json);			case 'FilmMakerWorkEntity':
			...
			return FilmMakerWorkWorksSubjectImages().fromJson(json);			case 'MTimeMovieDetailEntity':
			...
			return MTimeMovieDetailDataRelated().fromJson(json);			case 'HotWordTypeEntity':
			...
			return MoiveDetailsPopularReviewsAuthor().fromJson(json);			case 'FilmMakerEntity':
			...
			return FilmMakerPhoto().fromJson(json);			case 'ShortFilmReviewEntity':
			...
			return ShortFilmReviewSubjectImages().fromJson(json);			case 'SearchNewsEntity':
			...
			return SearchNewsResultResultList().fromJson(json);			case 'FilmMakerWorksEntity':
			...
			return NewsResultResultList().fromJson(json);			case 'WrittenJokesEntity':
			...
			return WrittenJokesResultShowapiResBodyContentlist().fromJson(json);			case 'QuotationEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'MovieStillsEntity':
			...
			return List<MovieStillsSubjectImages>();			case 'MtimeHotMovieEntity':
			...
			return List<MtimeHotMoviePromo>();			case 'FilmMakerWorkEntity':
			...
			return List<FilmMakerWorkWorksSubjectImages>();			case 'MTimeMovieDetailEntity':
			...
			return List<MTimeMovieDetailDataRelated>();			case 'HotWordTypeEntity':
			...
			return List<MoiveDetailsPopularReviewsAuthor>();			case 'FilmMakerEntity':
			...
			return List<FilmMakerPhoto>();			case 'ShortFilmReviewEntity':
			...
			return List<ShortFilmReviewSubjectImages>();			case 'SearchNewsEntity':
			...
			return List<SearchNewsResultResultList>();			case 'FilmMakerWorksEntity':
			...
			return List<NewsResultResultList>();			case 'WrittenJokesEntity':
			...
			return List<WrittenJokesResultShowapiResBodyContentlist>();			case 'QuotationEntity':
