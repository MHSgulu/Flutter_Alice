...
Future<ShortFilmReviewEntity> fetchMovieShortReviewData(String movieId) async {
  ...
  if (response.statusCode == 200) {
    return shortFilmReviewEntityFromJson(
        ShortFilmReviewEntity(), json.decode(response.body));
  } else {
    throw Exception('服务器未响应成功');
  }
}
...
class MovieDetailsScreen extends StatefulWidget {
  ...
  MovieDetailsScreen({Key key, @required this.movieId, @required this.imgUrl})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: dynamicBackgroundColor == null
            ? MyColors.movieDetailsBackgroundColor
          ...
          if (snapshot.hasData) {
            return ScrollConfiguration(
              behavior: CustomScrollBehavior(
                  isShowLeading: true,
                  isShowTrailing: true,
                  color: dynamicBackgroundColor == null
                      ? MyColors.movieDetailsBackgroundColor
                      : dynamicBackgroundColor),
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment:
                        CrossAxisAlignment.start, //该代码为了使简介栏 横轴 左开始
                    children: <Widget>[
                      ///电影信息栏
                      Container(
                            ...
                            Container(
                              ...
                              child: Card(
                                ...
                                shape: RoundedRectangleBorder(
                                    borderRadius:
                                        BorderRadiusDirectional.circular(2.0)),
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(
                                      padding: EdgeInsets.fromLTRB(0, 2, 0, 0),
                                      child: Text(
                                        ///检查durations List是否为空    null判断无效果 要用到isEmpty
                                                  ...
                                                  child: snapshot.data.rating
                                                      ...
                                                      : snapshot.data.rating.average >=
                                                          ...
                                                          : snapshot.data.rating
                                                              ...
                                                              : snapshot.data.rating.average >=
                                                                          6.5 &&
                                                                      snapshot.data.rating.average <= 7.4
                                                                  ? ThreeStarsHalfScore()
                                                                  : snapshot.data.rating.average >= 5.5 && snapshot.data.rating.average <= 6.4
                                                                      ...
                                                                      : snapshot.data.rating.average >= 4.5 && snapshot.data.rating.average <= 5.4
                                                                          ...
                                                                          : snapshot.data.rating.average >= 3.5 && snapshot.data.rating.average <= 4.4
                                                                              ? TwoStarsScore()
                                                                              : snapshot.data.rating.average >= 2.5 && snapshot.data.rating.average <= 3.4
                                                                                  ? OneStarsHalfScore()
                                                                                  : snapshot.data.rating.average >= 1.5 && snapshot.data.rating.average <= 2.4
                                                                                      ? OneStarsScore()
                                                                                      : snapshot.data.rating.average >= 0.5 && snapshot.data.rating.average <= 1.4
                                                                                          ? HalfStarsScore()
                                                                                          : NoStarsScore(),
                                                ),
                                              ],
                      ...
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment:
                              CrossAxisAlignment.start, //该代码为了使简介栏 两列文字 左对齐
                          children: <Widget>[
                            Container(
                              child: Text('简介',
                                  style: TextStyle(
                                    ...
                                    child: Card(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Image.network(
                                          ...
                                          snapshot.data.directors.length -
                                                      index >
                                                  0
                                              ? snapshot.data.directors[index]
                                                          .avatars ==
                                                      null
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: snapshot.data.trailers.isEmpty
                                                    ...
                                                    builder: (context) =>
                                                        PhotoViewGalleryScreen(
                                                          ...
                                                          index: index -
                                                              1, //传入当前点击的图片的index
                                                          heroTag:
                                                              'hero${index - 1}', //传入当前点击的图片的hero tag （可选）
                                                        )),
                                              );
                                            }
                                          } else {
                        ...
                        child: Container(
                          child: Column(
                            children: <Widget>[
                              ...
                              ///短评列表栏
                              Container(
                                child: snapshot.data.popularComments.isEmpty
                                    ? Container()
                                    : ListView.separated(
                                        shrinkWrap: true,
                                        physics: NeverScrollableScrollPhysics(),
                                        itemCount: snapshot
                                            .data.popularComments.length,
                                        separatorBuilder:
                                                            ...
                                                            Container(
                                                              child: Row(
                                                                children: <
                                                                  ...
                                                                  Container(
                                                                    //padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
                                                                    child: snapshot.data.popularComments[index].rating.value ==
                                                                            5
                                                                        ? FiveStarsScore()
                                                                        : snapshot.data.popularComments[index].rating.value ==
                                                                                4
                                                                            ? FourStarsScore()
                                                                            : snapshot.data.popularComments[index].rating.value == 3
                                                                                ? ThreeStarsScore()
                                                                                : snapshot.data.popularComments[index].rating.value == 2
                                                                                    ? TwoStarsScore()
                                                                                    : snapshot.data.popularComments[index].rating.value == 1
                                                                                        ? OneStarsScore()
                                                                                        : NoStarsScore(),
                                                                  ),
