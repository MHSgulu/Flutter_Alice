  ...
  Widget build(BuildContext context) {
    return dynamicBackgroundColor == null
        ...
        : Scaffold(
            ...
            body: FutureBuilder<MTimeMovieDetailEntity>(
              future: _future,
                          ...
                          children: <Widget>[
                                ...
                                children: <Widget>[
                                  Row(
                                    children: <Widget>[
                                      ...
                                      Container(width: 10),
                                      RatingBarIndicator(
                                        rating: snapshot.data.data.basic
                                                    .overallRating >
                                                0
                                      ...
                                      Text(
                                        snapshot.data.data.basic.overallRating <
                                            ...
                                            : '${snapshot.data.data.basic.overallRating}',
                                        style: TextStyle(
                                          fontSize: snapshot.data.data.basic
                                                      .overallRating <
                                                  0
                                              ? 12
                                              : 14,
                                          color: snapshot.data.data.basic
                                                      .overallRating <
                                                  0
                                              ? Colors.white60
                                              : Colors.white,
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount:
                                        snapshot.data.data.basic.type.length,
                                    itemBuilder:
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                scrollDirection: Axis.horizontal,
                                itemCount: snapshot
                                        .data.data.basic.stageImg.xList.length +
                                    1,
                                itemBuilder: (BuildContext context, int index) {
                                  return Card(
                                    clipBehavior: Clip.antiAlias,
