...
Future<NewsEntity> fetchNewsData() async {
  final response = await http.get('https://way.jd.com/jisuapi/get?channel=NBA&num=40&start=0&appkey=bd1ee420d53dcd93f21d338cd6bebba3');
...
/*NBA频道*/
class TabNewsListScreen12 extends StatefulWidget {
...
class NewsListScreenState extends State<TabNewsListScreen12> {
