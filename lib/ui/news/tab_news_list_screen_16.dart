...
Future<NewsEntity> fetchNewsData() async {
  final response = await http.get('https://way.jd.com/jisuapi/get?channel=%E5%81%A5%E5%BA%B7&num=40&start=0&appkey=bd1ee420d53dcd93f21d338cd6bebba3');
...
/*健康频道*/
class TabNewsListScreen16 extends StatefulWidget {
...
class NewsListScreenState extends State<TabNewsListScreen16> {
