...
Future<NewsEntity> fetchNewsData() async {
  final response = await http.get('https://way.jd.com/jisuapi/get?channel=%E6%98%9F%E5%BA%A7&num=40&start=0&appkey=bd1ee420d53dcd93f21d338cd6bebba3');
...
/*星座频道*/
class TabNewsListScreen14 extends StatefulWidget {
...
class NewsListScreenState extends State<TabNewsListScreen14> {
