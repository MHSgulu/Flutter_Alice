...
Future<NewsEntity> fetchNewsData() async {
  final response = await http.get('https://way.jd.com/jisuapi/get?channel=%E5%A4%B4%E6%9D%A1&num=40&start=0&appkey=bd1ee420d53dcd93f21d338cd6bebba3');
...
/*头条频道*/
class TabNewsListScreen1 extends StatefulWidget {
...
class  NewsListScreenState extends State<TabNewsListScreen1> {
