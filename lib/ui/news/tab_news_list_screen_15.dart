...
Future<NewsEntity> fetchNewsData() async {
  final response = await http.get('https://way.jd.com/jisuapi/get?channel=%E5%A5%B3%E6%80%A7&num=40&start=0&appkey=bd1ee420d53dcd93f21d338cd6bebba3');
...
/*女性频道*/
class TabNewsListScreen15 extends StatefulWidget {
...
class NewsListScreenState extends State<TabNewsListScreen15> {
