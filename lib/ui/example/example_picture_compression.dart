...
import 'file:///E:/Alice_flutter/alice/lib/values/resource.dart';
import 'package:alice/library/time_logger.dart';
...
class _MyAppState extends State<ExamplePictureCompression> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> compress() async {
    final img = AssetImage("assets/images/img_copertina.jpg");
    print("pre compress");
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          AspectRatio(
            child: Image(
              image: provider ?? AssetImage("assets/images/img_copertina.jpg"),
  ...
  Future compressListExample() async {
    final data = await rootBundle.load("assets/images/img_copertina.jpg");
